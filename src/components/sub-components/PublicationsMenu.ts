        ...
        return html`
            <div class="max-w-7xl mx-auto select-none">
                ...
                <div class="flex mx-5 my-5 flex-row flex-wrap justify-between md:justify-center md:mx-auto">                                    
                    <div class="publications-menu-divs hover:bg-[#1D2DAF]/90">Analyses & Commentaries</div>
                    <div class="publications-menu-divs hover:bg-[#1D2DAF]/90">The Covid of Things</div>
                    <div class="publications-menu-divs hover:bg-[#1D2DAF]/90">Predictability in Politics</div>
